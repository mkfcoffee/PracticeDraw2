...
public class Practice12PathEffectView extends View {
    ...
    DiscretePathEffect discretePathEffect = new DiscretePathEffect(30, 5);
...

    {
        ...
        dashPath.lineTo(30,40);
        dashPath.rLineTo(20,10);
        dashPath.close();
        pathDashPathEffect= new PathDashPathEffect(dashPath, 10, 0, PathDashPathEffect.Style.TRANSLATE);
    }
