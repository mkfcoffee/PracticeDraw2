...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    MaskFilter normalBlur = new BlurMaskFilter(20, BlurMaskFilter.Blur.NORMAL);
    MaskFilter innerBlur = new BlurMaskFilter(20, BlurMaskFilter.Blur.INNER);
    MaskFilter outerBlur = new BlurMaskFilter(20, BlurMaskFilter.Blur.OUTER);
    MaskFilter solidBlur = new BlurMaskFilter(20, BlurMaskFilter.Blur.SOLID);
